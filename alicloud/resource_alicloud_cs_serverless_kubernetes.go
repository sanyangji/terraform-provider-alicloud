	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"vswitch_id": {
				...
				Optional: true,
				Computed: true,
				Removed:  "Field 'vswitch_id' has been removed from provider version 1.226.0. New field 'vswitch_ids' replace it.",
			},
			"vswitch_ids": {
			...
			"force_update": {
				Type:     schema.TypeBool,
				Optional: true,
				Removed:  "Field 'force_update' has been removed from provider version 1.226.0.",
			},
			"security_group_id": {
				Type:     schema.TypeString,
				Optional: true,
			...
			"load_balancer_spec": {
				...
				Deprecated:   "Field 'load_balancer_spec' has been deprecated from provider version 1.226.0. The load balancer has been changed to PayByCLCU so that no spec is need anymore.",
			},
			"logging_type": {
				Type:       schema.TypeString,
				Optional:   true,
				Default:    "SLS",
				Deprecated: "Field 'logging_type' has been deprecated from provider version 1.226.0. Please use addons `alibaba-log-controller` to enable logging.",
			},
			"sls_project_name": {
				Type:       schema.TypeString,
				Optional:   true,
				Computed:   true,
				Deprecated: "Field 'sls_project_name' has been deprecated from provider version 1.226.0. Please use the field `config` of addons `alibaba-log-controller` to specify log project name.",
			},
			"time_zone": {
				Type:     schema.TypeString,
				Optional: true,
			...
			"create_v2_cluster": {
				...
				Optional: true,
				Computed: true,
				Removed:  "Field 'create_v2_cluster' has been removed from provider version 1.226.0.",
			},
			"rrsa_metadata": {
				Type:     schema.TypeList,
				Computed: true,
